    ...
    <div className="p-6 space-y-6">
          ...
          filteredMatches.map((match) => (
            <Card key={match.id} className="p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button data-testid={`button-view-details-${match.id}`} variant="ghost" size="sm">
      ...
      {filteredMatches.length > 0 && (
        <div className="flex items-center justify-center space-x-2 pt-6">
          <Button data-testid="button-prev-page" variant="ghost" size="sm" disabled>
            <ChevronLeft className="w-4 h-4" />
          </Button>
          <Button data-testid="button-page-1" className="bg-primary text-primary-foreground" size="sm">
            1
          </Button>
          <Button data-testid="button-page-2" variant="ghost" size="sm">
            2
          </Button>
          <Button data-testid="button-page-3" variant="ghost" size="sm">
            3
          </Button>
          <Button data-testid="button-next-page" variant="ghost" size="sm">
            <ChevronRight className="w-4 h-4" />
          </Button>
        </div>
      )}
